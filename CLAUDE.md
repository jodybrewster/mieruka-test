...
- **`npx mieruka init` fails with "package not found"** — mieruka may not be published yet; build it locally from `../mieruka/mieruka` and use the `--mcp-path` flag pointing to the local dist.
